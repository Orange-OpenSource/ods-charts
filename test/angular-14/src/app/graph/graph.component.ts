...
export class GraphComponent implements AfterViewInit {
  @ViewChild('graph') graph: ElementRef = undefined as unknown as ElementRef;
  ...
  public myTheme: ODSCharts.ODSChartsTheme | undefined;
  private echartsGraph: ECharts = undefined as unknown as ECharts;
