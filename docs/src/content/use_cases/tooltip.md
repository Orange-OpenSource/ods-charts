...
<div class="container-xxl pt-3">
  <div class="card w-100">
    <div class="card-body">
      <h5 class="card-title pe-5">Default Apache ECharts tooltip with a pie chart</h5>
      <div class="ms-5 mb-2 p-2 pe-5 text-body-secondary border-start border-warning bg-body-secondary">
        <p class="card-text text-body-secondary mb-0">
          This is not the recommended tooltip implementation. Without <code>externalizePopover()</code>, the native Apache ECharts tooltip only partially follows the Orange Unified Design System. Use <code>externalizePopover()</code> when full OUDS tooltip/popover compliance is required.
        </p>
      </div>
      <p class="card-text pe-5">
        This pie chart uses the native Apache ECharts item tooltip. No external tooltip or popover manager is registered.
      </p>
      <button class="btn btn-icon btn-outline-secondary btn-edit" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Open in playground">
        <svg width="1.25rem" height="1.25rem" fill="currentColor" aria-hidden="true">
          <use xlink:href="#lightning-charge-fill" />
      ...
      <div id="div9_htmlId">
        <div class="border border-subtle position-relative">
          ...
          <div id="div9_holder">
            <div id="div9_chart" style="width: 100%; height: 50vh" class="position-relative"></div>
          </div>
          <div id="div9_legend"></div>
        </div>
      </div>
      <script>
        var div9_htmlCode = getHtmlCode('div9_');
      </script>
      <script src="../../use_cases_code/tooltip_div9_codeId.js" id="div9_codeId" onload="addViewCode(div9_htmlCode,'div9_')"></script>
    </div>
  </div>
</div>
