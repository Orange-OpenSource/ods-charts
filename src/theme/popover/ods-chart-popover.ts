...
export class ODSChartsPopover {
  ...
  public addPopoverManagement(
    ...
    if (this.popoverConfig.enabled) {
      ...
      const perSeriesValueFormatters = new Map<number, (value: any, dataIndex: number) => string | undefined>();
      ...
      const globalValueFormatter: ((value: any, dataIndex: number) => string | undefined) | undefined = dataOptions?.tooltip?.valueFormatter;
