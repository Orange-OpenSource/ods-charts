...
/**
 * ODSChartsPopoverItem defines an item to be displayed in the popover/tooltip
 * It is used in {@link ODSChartsPopoverDefinition} methods to customize the content of the popover/tooltip
 * Example of use:
 * ```            
...
export class ODSChartsPopoverItem {
  ...
  label!: string;
  /** HTML marker rendered for this item in tooltip/popover content (already aligned with series/item color context) */
  marker!: string;
...
export class ODSChartsPopoverDefinition {
   ...
   * @param axisValue: value of the axis where the popup/tooltip is displayed
   * @param axisValueLabel: label of the axis where the popup/tooltip is displayed
   * @param name: name of the series where the popup/tooltip is displayed
   * @returns the html code of the popup/tooltip title
   */
  public getPopupTitle?: (axisValue: string, axisValueLabel?: string, name?: string) => string;
  /**
   * getPopupContent() may be specify to change the html code of all the popup/tooltip content
   * @param tooltipElements: elements to display in the popup/tooltip
   * @returns the html code of the popup/tooltip content
   */
   ...
   * The `tooltipElement.marker` field is pre-populated with the ODS marker HTML actually used for this line.
   * As an alternative, you can still use the marker generated by {@link ODSChartsTheme.getPopoverMarker}.
   * @param tooltipElement: element to display in the popup/tooltip line
   * @returns the html code of one line of the popup/tooltip
   */
   ...
   * @param tooltipElement: element to display in the popup/tooltip line
   * @returns the html code of the value displayed in the popup/tooltip
   */
   ...
   * This is not recommended except if you want to fully customize the popup/tooltip.
   * @param categoryLabel: label of the category where the popup/tooltip is displayed
   * @param tooltipElements: elements to display in the popup/tooltip
   * @returns the html code of the popup/tooltip
   */
